              ...
              Flexible(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      _buildGuideSection(l10n.guideIntro, l10n.guideIntroText, Icons.info_outline, titleSize, textSize),
                      const SizedBox(height: 16),
                      _buildGuideSection(l10n.guideGameFlow, l10n.guideGameFlowText, Icons.format_list_numbered, titleSize, textSize),
                      const SizedBox(height: 16),
                      _buildGuideSection(l10n.guideBidding, l10n.guideBiddingText, Icons.gavel, titleSize, textSize),
                      const SizedBox(height: 16),
                      _buildGuideSection(l10n.guideKitty, l10n.guideKittyText, Icons.swap_horiz, titleSize, textSize),
                      const SizedBox(height: 16),
                      _buildGuideSection(l10n.guideFriend, l10n.guideFriendText, Icons.people, titleSize, textSize),
                      const SizedBox(height: 16),
                      _buildGuideSection(l10n.guideSpecialCards, l10n.guideSpecialCardsText, Icons.star, titleSize, textSize),
                      const SizedBox(height: 16),
                      _buildGuideSection(l10n.guideJokerCall, l10n.guideJokerCallText, Icons.campaign, titleSize, textSize),
                      const SizedBox(height: 16),
                      _buildGuideSection(l10n.guideTrickPlay, l10n.guideTrickPlayText, Icons.style, titleSize, textSize),
                      const SizedBox(height: 16),
                      _buildGuideSection(l10n.guideScoring, l10n.guideScoringText, Icons.calculate, titleSize, textSize),
                      const SizedBox(height: 16),
                      _buildGuideSection(l10n.guideWinLose, l10n.guideWinLoseText, Icons.emoji_events, titleSize, textSize),
                      const SizedBox(height: 16),
                      _buildGuideSection(l10n.guideTips, l10n.guideTipsText, Icons.lightbulb_outline, titleSize, textSize),
                    ],
                  ),
                ),
              ),
