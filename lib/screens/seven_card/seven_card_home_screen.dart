...
class SevenCardHomeScreen extends StatelessWidget {
  ...
  Widget _buildPlayerStatRow(
    SevenCardPlayerStats playerStats,
    int playerIndex,
  ...
  void _showResetStatsDialog(BuildContext context, SevenCardStatsService statsService, AppLocalizations l10n) {
    showDialog(
      context: context,
              ...
              Flexible(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      _buildGuideSection(
                        l10n.sevenCardGuideOverview,
                        l10n.sevenCardGuideOverviewText,
                        Icons.info_outline,
                        titleSize,
                        textSize,
                      ),
                      ...
                      _buildGuideSection(
                        l10n.sevenCardGuideDealing,
                        l10n.sevenCardGuideDealingText,
                        Icons.style,
                        titleSize,
                        textSize,
                      ),
                      const SizedBox(height: 16),
                      _buildGuideSection(
                        l10n.sevenCardGuideBetting,
                        l10n.sevenCardGuideBettingText,
                      ...
                      const SizedBox(height: 16),
                      _buildGuideSection(
                        l10n.sevenCardGuideHands,
                        l10n.sevenCardGuideHandsText,
                        Icons.star,
                        titleSize,
                        textSize,
                      ),
                      const SizedBox(height: 16),
                      _buildGuideSection(
                        l10n.sevenCardGuideBonus,
                        l10n.sevenCardGuideBonusText,
                        Icons.celebration,
                        titleSize,
                        textSize,
                      ),
                      const SizedBox(height: 16),
                      _buildGuideSection(
                        l10n.sevenCardGuideTips,
                        l10n.sevenCardGuideTipsText,
